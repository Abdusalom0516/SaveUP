...
import 'package:boilerplate/core/services/logger_service.dart';
...
class ApiClient {
  ...
  void _initDio() {
    ...
    if (useAuth) {
      ...
      _dio.interceptors.add(AuthInterceptor(_dio, tokenService));
    }
  }
  ...
  Future<ApiResponse<T>> get<T>(
    ...
    try {
      ...
      return ApiResponse<T>.success(response.data as T, response: response);
    } catch (e) {
  ...
  Future<ApiResponse<T>> post<T>(
    ...
    try {
      ...
      log("Error on POST: ${e.response?.data}", error: e);
      LoggerService.e(message: e.toString());
      return ApiResponse<T>.error(_handleError(e));
    }
  }
  ...
  Future<ApiResponse<String>> download(
    ...
    try {
      ...
      return ApiResponse<String>.success(savePath, response: response);
    } catch (e) {
      return ApiResponse<String>.error(_handleError(e));
    }
  }
    ...
    switch (error.response!.statusCode) {
      ...
      default:
        return NetworkExceptions.defaultError(
          'Error with status code: ${error.response!.statusCode}, ${error.message}',
        );
    }
  }
